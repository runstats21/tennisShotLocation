...
# load MCMC samples
fn_samps = readRDS("./saved_data/allsamps_srploop.Rdata")
fdp_samps_hc = readRDS("./saved_data/samps_allrlocs_fdp_us2009.Rdata")
ndj_samps_grass = readRDS("./saved_data/samps_allrlocs_ndj_wim2018.Rdata")
...
# mv_test_all_rlocs = function(samps, p1_counts_mat, surface_name, players_abbrev, zones = c(2:5)) {}
# samps, p1_counts_mat # (rh mat, all zones), surface_name, players_abbrev, zones = c(2:5)
s = "grass" # name
samps = ndj_samps_grass
p1_counts_mat = nad_counts_dj
players_abbrev = "ndj"
# hard court given receive zone (in quotes or numeric)
# can also loop through all r_zones:
for (r_zone in 2:5) { # todo: change to 2:5
  # r_zone = 2
  ...
  saveRDS(null_vals_cur, file = paste0("./saved_data/null_values_s",cur_setting,players_abbrev,".Rdata"))
  saveRDS(median(null_vals_cur), file = paste0("./saved_data/null_median_s",cur_setting,players_abbrev,".Rdata"))
  ...
  saveRDS(gam_mat, file = paste0("./saved_data/gam_mat_s",cur_setting,players_abbrev,".Rdata"))
  ...
  saveRDS(contour_prob, file = paste0("./saved_data/ctr_prob_s",cur_setting,players_abbrev,".Rdata"))
...
mv_test_all_rlocs(samps = fdp_samps_hc,
                  p1_counts_mat=fed_counts_dp,
                  surface_name = "hard.court",
                  players_abbrev = "fdp",
